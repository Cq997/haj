...
function setupSheetsRTL() {
  ...
  const sheetsConfig = {
    ...
    'العهد الشخصية': ["وقت الحفظ", "تاريخ العهدة", "وقت العهدة", "القطاع", "الفترة", "نوع العهدة", "رقم العهدة/المعرف", "الأصناف", "ملاحظات عامة", "اسم كبير المسعفين والمساعدين", "اسم مدخل البيانات"],
    'الخزن الاستراتيجي': ["وقت الحفظ", "تاريخ التشييك", "وقت التشييك", "القائم بالتشييك", "موقع الخزن", "الفئة", "الصنف", "الحالة", "الكمية الحالية", "هل يوجد نقص طبي", "النواقص الطبية", "ملاحظات"],
...
function doPost(e) {
  try {
    ...
    if (sheetName === 'تشييك الوحدات' || sheetName === 'تشييك الوحدات التشغيلية' || sheetName === 'نموذج العهد الشخصية للقطاعات') {
